...
Paths{1} = '/athena/victorialab/scratch/hob4003/PFM/res0urces/'; % this folder contains ft_read / gifti functions for reading and writing cifti files (e.g., https://github.com/MidnightScanClub/MSCcodebase)

% define subject directory and surface files
Subdir = '/athena/victorialab/scratch/hob4003/lynch_2022_example_dataset';
